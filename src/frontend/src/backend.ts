...
export class Backend implements backendInterface {
    ...
    async getSubmissionById(arg0: SubmissionId): Promise<Submission> {
        if (this.processError) {
            try {
    ...
    async submitForm(arg0: string, arg1: Email, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<SubmissionId> {
        if (this.processError) {
            try {
